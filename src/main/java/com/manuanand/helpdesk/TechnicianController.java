...
public class TechnicianController {
	...
	///
	@PostMapping(path="/addTechnician") // Map ONLY POST Requests
	public @ResponseBody String addTechnician (
	...
	@GetMapping(path="/getAllTechnicians")
	...
	@GetMapping(path="/getTechnicianById")
	public @ResponseBody Technician getTechnicianById(@RequestParam Integer id) {
